//2015112232백근주
//자신만의 인터페이스를 정의한 BasicFormat를 호출하여 사용하여 똑같은 결과가 나오도록 한다. 
package Simple;
...
class SampleFormats{
	public static void main(String[] args) {
		...
		//BasicFormat 이용
		BasicFormat BF=new BasicFormat();
		System.out.println("\nBasicFormat 이용");
		System.out.println("Date: " + BF.formatDate(new GregorianCalendar(2005, 7, 4).getTime()));
		System.out.println("Integer: " + BF.formatLong(1234567));
		System.out.println("Integer: " + BF.formatLong(67.7));
		System.out.println("Money: " + BF.formatMoney(9812345.678));
		System.out.println("Money: " + BF.formatMoney(9812345));
		System.out.println("Money: " + BF.formatMoney(.78));
		System.out.println("Person: " + BF.formatPerson("Weinman", "Jerod", "weinman" ));
